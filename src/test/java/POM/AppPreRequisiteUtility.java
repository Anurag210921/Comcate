...
//
	...
	public void AgencySetup_VerifyAppConfigurations(String agencyName) throws InterruptedException {
		waitUntilElementIsVisible(By.xpath("//a[text()='Agencies']"));
		waitUntilElementPresent(By.xpath("//a[text()='Agencies']"));
		...
		String agencyId = getTextElement(By.xpath("(//div[@role='grid']//div[@role='gridcell'])[1]"));
	...
	public void AddCustomLocationfields(String locationfieldName, String type) throws InterruptedException {
		...
		if (locationfieldName.equalsIgnoreCase("Zip")) {
			...
			waitForElementIsInteractable(By.xpath("//a[@class='picklist-options__add']"));
			clickOn(By.xpath("//a[@class='picklist-options__add']"));

			clickByJsExecuter(By.xpath("//a[@class='picklist-options__add']"));
			waitForElementIsInteractable(By.xpath("(//input[@placeholder='Enter Text'][@name='option'])[1]"));
			sendKeysWithWait(By.xpath("(//input[@placeholder='Enter Text'][@name='option'])[1]"), "A");

			waitForElementIsInteractable(By.xpath("(//input[@placeholder='Enter Text'][@name='option'])[2]"));
			sendKeysWithWait(By.xpath("(//input[@placeholder='Enter Text'][@name='option'])[2]"), "B");
	...
	public void AgencySetup_VerifyCaseAssignmentRules() throws InterruptedException {
		...
		if (BrowsersInvoked.RunEnvironment.equalsIgnoreCase("Stage")) {
			ceCommonMethod.addCaseAssignmentRule("Case Violation", "Contains", "Water", "Mark Shane", "Amandeep");
			Thread.sleep(2000);
			ceCommonMethod.addCaseAssignmentRule("Case Violation", "Contains", "Animal", "Mark Shane", "Amandeep");
		}
			...
			ceCommonMethod.addCaseAssignmentRule("Case Violation", "Contains", "Water", "Shane Es", "Amandeep");
			Thread.sleep(2000);
			ceCommonMethod.addCaseAssignmentRule("Case Violation", "Contains", "Animal", "Shane Es", "Amandeep");
		}
	...
	public void AgencySetup_VerifySubmissionAssignmentRules() throws InterruptedException {
		...
		ceCommonMethod.deleteRules(0);
		if (BrowsersInvoked.RunEnvironment.equalsIgnoreCase("stage")) {
			ceCommonMethod.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Required",
					"Mark Shane", "Amandeep Singh");
			ceCommonMethod.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Not Required",
					"Mark Shane", "Amandeep Singh");
			ceCommonMethod.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Not Included",
					"Mark Shane", "Amandeep Singh");
		}

		else if (BrowsersInvoked.RunEnvironment.equalsIgnoreCase("Production")) {
			ceCommonMethod.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Required", "Amandeep",
					"Amandeep Singh");
			ceCommonMethod.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Not Required",
			...
			ceCommonMethod.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Required", "Shane ES",
					"Amandeep Singh");
			ceCommonMethod.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Not Required",
					"Shane ES", "Amandeep Singh");
			ceCommonMethod.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Not Included",
					"Shane ES", "Amandeep Singh");
		}
	...
	// CECommonMethods.addSubmissionAssignmentRule("Submission Category", "Equals",
	// "Location Required", "Mark Shane", "Amandeep");
	...
	public void AgencySetup_VerifyCreationOfLCFs() throws InterruptedException {
		...
		waitForPresenceandVisiblity(CreateCustomFieldButton);
		AddCustomLocationfields("Zip", "Populated from parcel File");
		AddCustomLocationfields("Block", "Number");
		AddCustomLocationfields("Zone", "Picklist");
		SoftAssert softAssert = new SoftAssert();
		softAssert.assertEquals(AppPreRequisiteUtility.LCFTabTitle, "Location Custom Fields");
	...
	public void AgencySetup_VerifyUploadedMapLayer() throws InterruptedException {
		...
		if (BrowsersInvoked.agencyConfig.equalsIgnoreCase(BrowsersInvoked.agencyConfigGisDirect2o)) {
			waitForElementIsInteractable(By.xpath("//button[text()='KML File']"));
			clickByJsExecuter(By.xpath("//button[text()='KML File']"));
		...
		clickByJsExecuter(MapLayersTab);
		Thread.sleep(3000);
		System.out.println("successsfull enter in maplayers tab");
		waitForCurserRunning(3);
		waitForPresenceandVisiblity(UploadMapLayerButton);
		waitForElementIsInteractable(UploadMapLayerButton);
		Thread.sleep(3000);
		waitForPresenceandVisiblity(By.cssSelector("div.sortable-table__body__td"));
	...
	public void AgencySetup_VerifyCreatedUser() throws InterruptedException {
		...
		ceCommonMethod.createCustomeUsers("two", "User", "Agency Admin CRM and CEM");
		Thread.sleep(4000);
		ceCommonMethod.createCustomeUsers("Amandeep", "Singh", "Agency Admin CRM and CEM");
		Thread.sleep(4000);
		ceCommonMethod.createCustomeUsers("Mark", "Shane", "Agency Admin CRM and CEM");
		Thread.sleep(4000);
		ceCommonMethod.createCustomeUsers("Shane", "ES", "Agency Admin CRM and CEM");
		Thread.sleep(4000);
		ceCommonMethod.createCustomeUsers("CE", "User", "Product Admin CEM");
		Thread.sleep(4000);
		ceCommonMethod.createCustomeUsers("CRM", "User", "Product Admin CRM");
		Thread.sleep(4000);

		ceCommonMethod.createCustomeUsers("dummy", "User", "Agency Admin CRM and CEM");
		Thread.sleep(4000);
		ceCommonMethod.createCustomeUsers("Supervisor", "Manager", "Supervisor Manager");
		Thread.sleep(4000);
		ceCommonMethod.createCustomeUsers("Non", "Supervisor", "No Supervisor");
		Thread.sleep(4000);
		ceCommonMethod.createCustomeUsers("Basic", "Supervisor", "Basic Supervisor");
		Thread.sleep(4000);
		SoftAssert softAssert = new SoftAssert();
	...
	public void AddRequiredNonRequiredLabelToFAAActivity(String labelCount, String labelName, String required,
		...
		if (type.equalsIgnoreCase("Picklist")) {
			...
			waitUntilElementIsVisible(By.xpath("//div[contains(text(),'Manage Picklist')]"));
			forcedWaitTime(2);
			clickByJsExecuter(By.xpath("//a[@class='picklist-options__add']"));
			forcedWaitTime(2);
			clickByJsExecuter(By.xpath("//a[@class='picklist-options__add']"));
			waitForElementIsInteractable(By.xpath("(//input[@placeholder='Enter Text'][@name='option'])[1]"));
			sendKeysWithWait(By.xpath("(//input[@placeholder='Enter Text'][@name='option'])[1]"), "Yes");

			waitForElementIsInteractable(By.xpath("(//input[@placeholder='Enter Text'][@name='option'])[2]"));
			sendKeysWithWait(By.xpath("(//input[@placeholder='Enter Text'][@name='option'])[2]"), "No");
			waitUntilElementIsVisible(By.xpath("//button[text()='Save']"));
			waitForElementIsInteractable(By.xpath("//button[text()='Save']"));
			clickOn(By.xpath("//button[text()='Save']"));
	...
	public void AgencySetup_VerifyAdditionOfFAActivity() throws InterruptedException {
		...
		waitUntilElementIsVisible(By.xpath("//h4[contains(text(),'Proposed Forced Abatement')]"));
		waitForElementIsInteractable(CreateFAActivityButton);
		clickByJsExecuter(CreateFAActivityButton);
		waitForPresenceandVisiblity(LabelFieldFAA);
		waitForElementIsInteractable(LabelFieldFAA);
		...
		String RandomDescription = RandomStrings.requiredString(20);
		sendKeysWithWait(DescriptionFieldFA, RandomDescription);
		AddRequiredNonRequiredLabelToFAAActivity("1", "Select Date", "No", "Date");
		AddRequiredNonRequiredLabelToFAAActivity("2", "Case ID", "Yes", "Text");
		AddRequiredNonRequiredLabelToFAAActivity("3", "Case Number", "Yes", "Number");
		AddRequiredNonRequiredLabelToFAAActivity("4", "Any Other Linked Case", "Yes", "Picklist");
		...
		AddNonRequiredLabelFAAActivity("Activity Two", "Label");
		AddNonRequiredLabelFAAActivity("Responsive", "Response");
		AddedFAActivityCount = getTextByJSExecutor(
				By.xpath("(//span[contains(text(),'Forced Abatement Activities')])[1]//parent::h2")).split(" ")[0];
		SoftAssert softAssert = new SoftAssert();
	...
	public void AgencySetup_VerifyCreationOfViolations() throws InterruptedException {
		...
		crmCommonMethod.addNewViolationAdmin("Water");
		...
		waitForCurserRunning(2);
		waitForPresenceandVisiblity(CreateViolationPopup);
		crmCommonMethod.addNewViolationAdmin("Animal");
		refreshPage();
		waitForPresenceandVisiblity(CreateViolationButton);
		scrollIntoView(CreateViolationButton);
		waitForElementIsInteractable(CreateViolationButton);
		...
		waitForCurserRunning(2);
		waitForPresenceandVisiblity(CreateViolationPopup);
		crmCommonMethod.addNewViolationAdmin("WaterFF");
		waitForPresenceandVisiblity(AddedViolationsRows);
		AddedViolations = findElementsByXPath(AddedViolationsRows);
		CheckVio2 = (AddedViolations.size() == 3);
		SoftAssert softAssert = new SoftAssert();
	...
	public void AgencySetup_VerifyInvalidDispositionCreation() throws InterruptedException {
		...
		waitForElementIsInteractable(LabelField);
		sendKeysWithWait(LabelField, "Invalid Dispositionnn");
		waitForElementIsInteractable(CreateDispositionButton);
		clickByJsExecuter(CreateDispositionButton);
		...
		waitForPresenceandVisiblity(By.xpath(getMuncipalVioCode("Invalid Dispositionnn")));
	...
	public void CreateViolationEscalatedNotice(String escalatedNotice, String violationLink, String fAdocument,
		...
		if (fAdocument.equalsIgnoreCase("Yes")) {
			waitForElementIsInteractable(By.xpath("//button[text()='FA Document']"));
			clickByJsExecuter(By.xpath("//button[text()='FA Document']"));
	...
	public void AgencySetup_VerifyCreationOfHTMLNotice() throws InterruptedException {
		...
		CreateViolationEscalatedNotice("Yes", "No", "No", "EscalatedNotice");
		CreateViolationEscalatedNotice("No", "Yes", "No", "HTML Mandatory Notice");
		CreateViolationEscalatedNotice("No", "Yes", "No", "Notice For Violation Fine Linked To Violations");
		CreateViolationEscalatedNotice("No", "Yes", "No", "HTML Flat Fine Notice");
		CreateViolationEscalatedNotice("No", "Yes", "Yes", "FA document with Flat Fine");
		CreateViolationEscalatedNotice("No", "Yes", "No", "Notice For Violation Specific Fine Linked To Notice");
	...
	public void AgencySetup_VerifyCreationOfFADocument() throws InterruptedException {
		...
		ceCommonMethod.creationCustomeFANotices("HTML FA Document",
				PropertiesUtils.getPropertyValue("FANoticeMergeField"));
		Thread.sleep(3000);
		ceCommonMethod.creationCustomeFANotices("HTMLmuniCodeResolutionImg",
	...
	public void AgencySetup_VerifyCreationOfCategories() throws InterruptedException {
		...
		for (int i = 0; i < 3; i++) {
			...
			crmCommonMethod.createCategoryAppPrerequisute("No", "Yes", "Yes", categoryName);
		}

		// Add more 3 category to complete the pre-requisite for the CE and CRM
		for (int i = 0; i < 3; i++) {
			String categoryName = "Category " + RandomStrings.requiredString(5);
			crmCommonMethod.createCategoryAppPrerequisute("No", "No", "Yes", categoryName);
		}

		// Mandatory Category for the CRM and CRM External
		waitForPresenceandVisiblity(CategoryPage.CreateCategoryButton);
		crmCommonMethod.createCategoryAppPrerequisute("No", "Yes", "Yes", "Location Not Required");
		crmCommonMethod.createCategoryAppPrerequisute("Yes", "Yes", "Yes", "Location Required");
		crmCommonMethod.createCategoryAppPrerequisute("No", "No", "Yes", "Location Not Included");

		// Add more 3 category to complete the pre-requisite for the CE and CRM
		for (int i = 0; i < 3; i++) {
			String categoryName = "Category " + RandomStrings.requiredString(5);
			crmCommonMethod.createCategoryAppPrerequisute("Yes", "Yes", "Yes", categoryName);
		}
	...
	public void AgencySetup_VerifyCreationOf50PlusSubmissions() throws InterruptedException {
		...
		for (int i = 0; i <= 50; i++) {
			crmCommonMethod.createSubmissionPreRequisite("No", "Yes", "No", "No", "No", "Location Not Required");
		}
		SoftAssert softAssert = new SoftAssert();
		softAssert.assertAll();
	}
	...
	public void AgencySetup_VerifyCaseCreationWithEntityViolation() throws InterruptedException {
		...
		waitForPresenceandVisiblity(CCPUtility.ViolationSearchBox);
		sendKeysWithWait(CCPUtility.ViolationSearchBox, "Animal");
		...
		sendKeysWithWait(CCPUtility.AnimalColourField, "Black");
		...
		waitForPresenceandVisiblity(CCPUtility.AnimalColourField);
		sendKeysWithWait(CCPUtility.AnimalColourField, "White");
		waitForPresenceandVisiblity(PerformInspectionUtility.AddButtonViolation);
		clickByJsExecuter(PerformInspectionUtility.AddButtonViolation);
		...
		waitForCurserRunning(4);
		if (BrowsersInvoked.RunEnvironment.equalsIgnoreCase("Stage")) {
			ceCommonMethod.selectCaseAssineCCP("Mark Shane");
			ceCommonMethod.selectInspectionAssineCCP("Mark Shane");
		} else if (BrowsersInvoked.RunEnvironment.equalsIgnoreCase("Production")) {
			ceCommonMethod.selectCaseAssineCCP("Amandeep Singh");
			ceCommonMethod.selectInspectionAssineCCP("Amandeep Singh");

		} else {
			ceCommonMethod.selectCaseAssineCCP("Shane Es");
			ceCommonMethod.selectInspectionAssineCCP("Shane Es");
		}
	...
	public String ExpectedCrtFineLabelValidMsg = "The Label is required.";
	public String ExpectedCrtFineDefaultAmntValidMsg = "Number should be greater than 0";

	public String ActualNoticeRequiresValidMsg;
	public String ExpectedNoticeRequiresValidMsg = "The Notice is required.";
	...
	public void CreationViolationSpecificOnlyFine(String violationFineName, String amount, boolean attachednotice,
		...
		fines.setValueInDefaultAmountField("100");
		if (attachednotice) {
	...
	public void AgencySetup_VerifyFlatFineCreationDoNotAttachedNotices() throws InterruptedException {
		...
		create_FlatFineNoNoticesViolationAttached("Flat Fine With No Notice And No FA", "10000");
	...
	public void AgencySetup_VerifyFlatFineCreationAttachedNotices() throws InterruptedException {
		...
		waitForPresenceandVisiblity(CrtFineSelectNoitce);
		clickByJsExecuter(CrtFineSelectNoitce);
		waitForPresenceandVisiblity(CrtFineCheckHtmlNotice);
		clickByJsExecuter(CrtFineCheckHtmlNotice);
		waitForPresenceandVisiblity(CrtFineApplyNotices);
		clickByJsExecuter(CrtFineApplyNotices);
		waitForElementIsInteractable(CreateFinePopUpbtn);
		clickByJsExecuter(CreateFinePopUpbtn);
		...
		create_FlatFineAttachedNotices("HTML Mandatory Notice Fine", "10000", "HTML Mandatory Notice");
		create_FlatFineAttachedNotices("Flat Fine With FA Document", "10000", "FA document with Flat Fine");
		create_FlatFineAttachedNotices("Flat Fine With Notice", "10000", "HTML Flat Fine Notice");
	...
	public String ExpectedCrtLateFeeLabelValidMsg = "The Label is required.";
	...
	public void createRoles() throws InterruptedException {
		...
		ceCommonMethod.roleCreationWithCECRMSettings("No Supervisor", "No Supervisor Role",
				"This Role is Non Supervisore.");
		ceCommonMethod.openCreateRolePopUp();
		ceCommonMethod.roleCreationWithCECRMSettings("Basic Supervisor", "Basic Supervisor",
				"This Role is Basic Supervisore.");
		ceCommonMethod.openCreateRolePopUp();
		ceCommonMethod.roleCreationWithCECRMSettings("Supervisor Manager", "Supervisor Manager",
				"This Role is Basic Supervisore.");

	}

	public void createGroups() throws InterruptedException {
		String[] usersNameGroup1 = { "Basic Supervisor", "dummy User" };
		String[] usersNameGroup2 = { "Basic Supervisor", "Mark Shane", "Supervisor Manager", "Non Supervisor" };
		umUtils.createGroupWithUser("BasicUserDummyUser", "Basic and Dummy User Group", usersNameGroup1);
		forcedWaitTime(4);
		umUtils.createGroupWithUser("BasicNonManagerSupervisor", "Basic and Dummy User Group", usersNameGroup2);
	}
