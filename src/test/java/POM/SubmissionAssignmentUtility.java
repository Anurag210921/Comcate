...
public class SubmissionAssignmentUtility extends Helper{
    ...
    public void SubmissionAssignmentBaseOnAddedRule() throws InterruptedException{
        ...
        if(BrowsersInvoked.RunEnvironment.equalsIgnoreCase("stage")) {
            ce.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Required", "Mark Shane", "Amandeep Singh");
            ce.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Not Required", "Mark Shane", "Amandeep Singh");
            ce.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Not Included", "Mark Shane", "Amandeep Singh");
        }
        else if (BrowsersInvoked.RunEnvironment.equalsIgnoreCase("Production")){
        	
        	
            ce.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Required", "Amandeep", "Amandeep Singh");
            ce.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Not Required", "Amandeep", "Amandeep Singh");
            ce.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Not Included", "Amandeep", "Amandeep Singh");
        }
        else {
        ce.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Required", "Shane ES", "Amandeep Singh");
        ce.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Not Required", "Shane ES", "Amandeep Singh");
        ce.addSubmissionAssignmentRule("Submission Category", "Equals", "Location Not Included", "Shane ES", "Amandeep Singh");
    ...
    public  void CaseAssignmentBaseOnAddedRule() throws InterruptedException{
        ...
        ce.deleteRules(0);
        if(BrowsersInvoked.RunEnvironment.equalsIgnoreCase("Stage")) {
            ce.addCaseAssignmentRule("Case Violation", "Contains", "Water", "Mark Shane", "Amandeep Singh");
        }
        else if(BrowsersInvoked.RunEnvironment.equalsIgnoreCase("Production")) {
        	 ce.addCaseAssignmentRule("Case Violation", "Contains", "Water", "Amandeep", "Amandeep Singh");
        }
        else{
//            ce.addCaseAssignmentRule("Case Violation", "Contains", "Water 01", "Shane ES", "Amandeep Singh");
            ce.addCaseAssignmentRule("Case Violation", "Contains", "Water", "Shane ES", "Amandeep Singh");
