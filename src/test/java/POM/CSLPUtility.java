	...
	public void LoginAgency() throws InterruptedException {
	  ...
	  public static String cSLPTab = "//a[text()='Customer Submissions']";
	    ...
	    public  void CSLP_VerifyTagFilter() throws InterruptedException {
	        ...
	        waitUntilElementIsVisible(By.xpath("//div[@role='columnheader']//div[text()='Issue Description']"));
	    ...
	    public  void CSLP_VerifyTotalCountOfSubmissions() throws InterruptedException {
	        ...
	        Boolean check = driver.findElement(By.xpath("//div[@class='pagination-top']//div[@class='table__pagination-nav-btns']/button[2]")).isEnabled();
	        while(check) {
	        	   // waitForElementIsInteractable(By.xpath("//div[@class='pagination-top']//div[@class='table__pagination-nav-btns']/button[2]"));
		            clickByJsExecuter(By.xpath("//div[@class='pagination-top']//div[@class='table__pagination-nav-btns']/button[2]"));
		           // WaitForGridTableEnable();
		            forcedWaitTime(3);
		            int eleCount1 =findElementsByXPath(SubmissionID).size();
		            eleCount = eleCount + eleCount1;
		            System.out.println(eleCount);
		            check = driver.findElement(By.xpath("//div[@class='pagination-top']//div[@class='table__pagination-nav-btns']/button[2]")).isEnabled();
	    ...
	    public  void CSLP_VerifyClearAllFiltersLinkText() throws InterruptedException {
	        refreshPage();
	        waitForCurserRunning(7);
            crmMethods.searchSubmissionCSLP("Submission");
...
//	        refreshPage();
//	        waitForCurserRunning(4);
//	        waitUntilElementIsVisible(TagsUnderColumn);
//	        waitForElementIsInteractable(TagsUnderColumn);
//	        clickByJsExecuter(TagsUnderColumn);
	        waitUntilElementIsVisible(ClearAllFiltersLink);
	        waitForElementIsInteractable(ClearAllFiltersLink);
	    ...
	    public  void CSLP_VerifyNoExistingCategorySubmission() throws InterruptedException{
	        ...
	        waitUntilElementIsVisible(By.xpath("//div[@id='categoryIds']//ul//li"));
	       // waitUntilElementIsVisible(By.xpath("//div[@id='categoryIds']//ul//li//label[contains(text(),'"+categoryName+"')]"));
	         forcedWaitTime(4);
			 Thread.sleep(3000);
	        scrollIntoView(By.xpath("//div[@id='categoryIds']//ul//li//label[contains(text(),'"+categoryName+"')]"));
			clickByJsExecuter(By.xpath("//div[@id='categoryIds']//ul//li//label[contains(text(),'"+categoryName+"')]"));
	        waitForCurserRunning(2);
