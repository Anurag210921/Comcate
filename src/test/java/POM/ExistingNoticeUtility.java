...
public class ExistingNoticeUtility extends Helper {
	...
	public static By continueBtn2 = By.xpath("(//div[@class='progressive-form__footer']//button[@class='square-btn btn btn-primary'])[2]");
	public static By reviewOpenViolationsComplyDatesHeaderText = By.xpath("//h2[text()='Review Open Violations & Comply By Dates']");
	public static By continueBtn3 = By.xpath("(//div[@class='progressive-form__footer']//button[@class='square-btn btn btn-primary'])[3]");
	public static By followupInspectionDateHeaderText = By.xpath("(//div[@class='progressive-form__footer']//button[@class='square-btn btn btn-primary'])[3]");
	...
	public static By independentNoticeCreateSection = By.xpath("//h4[text()='Notice created independent of Follow-up inspection']");
    ...
    public static By whichNoticeDoyouWantToggle  = By.xpath("(//div[@class='multi-choice-buttons']//button[@class='square-btn btn btn-primary'])[2]");
    public static By finishInspectionAndApplyBtn  = By.xpath("//button[text()='Finish Inspection and Apply']");
    public static By viewNoticeLink  = By.xpath("(//div[@class='abatement-activities__done-cta']//a[text()='View Notice'])[2]");
    ...
    public static By addContactField = By.xpath("//input[@placeholder='Find contact by name, email or phone number or start typing to create a new contact']");
	...
	public void existingNotice_PreRequisite()throws InterruptedException {
		...
		Thread.sleep(5000);
		CECommonMethodS.addViolationParam("Wa");
		Thread.sleep(5000);
		...
		if (no > 0) {
			...
			{
				clickByJsExecuter(By.xpath("//*[@class='contact__actions']//*[@class='delete-btn  btn btn-primary']"));
	...
	public void existingNotice_CloseConfirmationPopup() throws InterruptedException {
		...
		clickOn(noButton);
		forcedWaitTime(2);
		int noBtn = fineElementsSize(noButton);
		if (noBtn == 0) {
	...
	public void existingNotice_OpenVerificationInspProgressPopup() throws InterruptedException {
		clickOn(CDP_Utility.performInspectionBtn);
        ...
        int htmlSizebtn = driver.findElements(By.xpath("//*[@class='multi-choice-buttons']//button[starts-with(text(),'HTML')]")).size();
        if (htmlSizebtn > 0) {
	...
	public void existingNotice_GenerateNoticeOutofInpec() throws InterruptedException {
		...
		waitForElementIsInteractable(By.xpath("//div[@class='multi-choice-buttons']/button[(starts-with(text(),'HTML'))]"));
      	int htmlSizebtn2 = driver.findElements(By.xpath("//div[@class='multi-choice-buttons']/button[(starts-with(text(),'HTML'))]")).size();
   ...
   public void existingNotice_DeleteNotice() throws InterruptedException {
	   scrollIntoView(applyNoticeBtn);
       waitForElementIsInteractable(applyNoticeBtn);
	   clickOn(applyNoticeBtn);
	   String followUpInpPopUpTitle = getTextElement(followUpInspPopupTitle);
	   String expectedPopupText = "Follow Up Inspection";
	   softAssert.assertEquals(followUpInpPopUpTitle, expectedPopupText);
	   softAssert.assertAll();
	   waitForElementIsInteractable(continueBtn5);
	   clickOn(continueBtn5);
	   waitForElementIsInteractable(yesButton);
	   clickOn(yesButton);
	   waitForCurserRunning(10);
       waitForElementIsInteractable(viewNoticeLink);
