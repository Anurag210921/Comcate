...
public class AgencyCreationUtility extends Helper {
	...
	public void agencyCreation_ConfigureCE() throws InterruptedException {
		...
		waitUntilElementIsVisible(By.xpath("//span[@class='toggle__children'][text()='Animal']"));
	...
	public void agencyCreation_VerifyNewAgencyCreation() throws InterruptedException {
		...
		sendKeysWithWait(StreetAddressField, "21 Lane");
		waitForElementIsInteractable(CityField);
		sendKeysWithWait(CityField, "Austin");
		...
		sendKeysWithWait(EmailField, "newagencyviaautomation@yopmail.com");


		// Add  website mail address
		waitForElementIsInteractable(WebsiteURLField);
		sendKeysWithWait(WebsiteURLField, "https://demo.comcate.com");
		...
		sendKeysWithWait(SendFromEmailField, "team-comcate");
		...
		softAssert.assertTrue(deleteBtn, "Delete Icon is not present.");
		softAssert.assertAll();
	...
	public void deleteCreatedAgency() throws InterruptedException {
		...
		softAssert.assertEquals(actualText, "No Agencies match the given criteria.");
		softAssert.assertAll();
	}
