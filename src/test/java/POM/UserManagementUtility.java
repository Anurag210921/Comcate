...
public class UserManagementUtility extends Helper {
	...
	public void UserManagement_VerifyUserGetsCreated() throws InterruptedException {
		...
		sendKeysWithWait(LastNameField, RandomLastName);
	...
	public void UserManagement_VerifyCountOfUsers() throws InterruptedException {
		...
		waitUntilElementIsVisible(PaginationText);
		String[] Pagination = getTextElement(PaginationText).split(" ");
		String PaginationCount = Pagination[1];
		int PgCount = Integer.parseInt(PaginationCount);
		waitUntilElementIsVisible(NextPagination);
		waitUntilElementPresent(NextPagination);
		...
		while (eleCheck) {
			...
			forcedWaitTime(2);
			waitUntilElementPresent(By.xpath("//button[@type='button'][@class='edit-btn  btn btn-primary']"));
			waitForElementIsInteractable(By.xpath("//button[@type='button'][@class='edit-btn  btn btn-primary']"));
	...
	public void addUsersInGroup(String[] username) throws InterruptedException {
...
//			forcedWaitTime(3);
	...
	public void createGroupWithUser(String groupName,String description ,String[] username) throws InterruptedException {
