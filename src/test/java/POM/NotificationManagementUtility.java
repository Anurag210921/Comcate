...
public class NotificationManagementUtility extends Helper {
	...
	public static String SelectAttributeOption = "//div[@class='Select-menu-outer']//div[@aria-label='%s']";
	...
	public void SelectRecipient(String Option) {
		waitForElementIsInteractable(By.xpath(stringFormat(recipientOptions, Option)));
	...
	public static String SelectCustomeActionValue(String value) {
		...
		//           //div[@class='Select-menu-outer']//div[@aria-label='Code Case Management']         Code Case Management
		return xPath;
	}
	...
	public void SelectRuleValue(String Option) {
		waitUntilElementIsVisible(By.xpath(stringFormat(SelectValueOption, "all")));
		waitForElementIsInteractable(By.xpath(stringFormat(SelectValueOption, "all")));
		clickByJsExecuter(By.xpath(stringFormat(SelectValueOption, "all")));
	}
