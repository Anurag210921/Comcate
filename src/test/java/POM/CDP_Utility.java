...
public class CDP_Utility extends Helper {
	...
	public By deleteContact = By
			.xpath("(//div[@class='contact__actions']//button[@class='delete-btn  btn btn-primary'])[2]");
	...
	public static By checkMarkForNoticeApproved = By.xpath("(//div[@class='abatement-activities__done']/span)[1]");
	public static By approvedAndAppliedToCaseText = By.xpath("//span[@class='escalated-label approved-applied']");
...
//		waitForCurserRunning(4);
		...
		if(!(elementIsDisplayed(By.cssSelector("#skip-inspection"))))
		{
	...
	public void CDP_VerifyCaseHistory() throws InterruptedException {
		...
		waitUntilElementIsVisible(closebtn);
		clickByJsExecuter(closebtn);
...
//		waitForElementIsInteractable(ccp.CreateScheduleInspectionButton);
	...
	public By selectFineOptions = By.xpath("//div[@class='Select-menu-outer']/div/div[1]");
	...
	public void CDP_VerifyOverdueFinePayment() throws InterruptedException {
		...
		clickByJsExecuter(op.SelectFineDropdownArrow);
		waitUntilElementIsVisible(op.SelectFineOptions);
		clickByJsExecuter(op.SelectFineOptions);
	...
	public void CDP_VerifyOustandingBalWithCLP() throws InterruptedException {
		...
		oustandingBalCLP = getTextElement(By.xpath("(//div[@role='gridcell']//div)[15]"));
	...
	public void VerifyEsclatedNoticeStatusAppearToSupervisorManager() throws InterruptedException {
		...
		Thread.sleep(2000);
		Boolean ApprovedApplied_Notice = elementIsDisplayed(By.xpath("//span[text()='Approved & Applied to Case']"));
