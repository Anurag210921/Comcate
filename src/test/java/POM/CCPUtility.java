...
public class CCPUtility extends Helper {
	...
	public static String streetLabel = "//label[text()='Street Address']//following-sibling::label";
	public static String cityLabel = "//label[text()='City']//following-sibling::label";
	public static String zipLabel = "(//label[text()='Zip']//following-sibling::label)[1]";
	...
	public void CCP_SearchAndAddAddress() throws InterruptedException {
		...
		if (agencyConfig.equalsIgnoreCase(agencyConfigGisDirect1o)) {
			...
			String ValidateStreetAdd = getTextElement(By.xpath(AddAttachmentCCP));
			SoftAssert s5b = new SoftAssert();
	...
	public void CCP_AddViolationWithoutEntity() throws InterruptedException {
		...
		sendKeysWithWait(ViolationSearchBox, "Wa");
...
//		clickByJsExecuter(By.xpath("//button[@class='attach-btn btn btn-primary']"));
		...
		try {
			...
			UploadFile4.sendKeys(System.getProperty("user.dir") + "/TestData/Cat_11zon.jpg");
			implicitWaitforCustometime(10);
		}
		// Thread.sleep(3000);
