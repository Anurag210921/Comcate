...
public class GenerateNoticeOutOfInspectionUtility extends Helper {
	...
	public void verifyViolationsCannotBeUpdated() {
	...
	public void verifyOnlyHTMLNoticesAreDisplayed() throws InterruptedException {
		...
		for (int i = 0; i < notices.size(); i++) {
			...
			if (!(noticeName.contains("HTML") || noticeName.contains("Escalated"))) {
	...
	public void verifyFineAssociatedWithNoticeIsDisplayed() {
		...
		Boolean flag = elementIsDisplayed(CDP_Utility.associatedFineLabelForHTMLMandatory);
	...
	public void verifyUnaplliedNoticeAppearsAfterClosingCase() {
		Assert.assertTrue(elementIsDisplayed(CDP_Utility.noticeCreatedIndependentOfInspectionHeader));

	}

	public void voidverifyApplyNoticeBtnNotDisplayed() {
		Assert.assertFalse(elementIsDisplayed(CDP_Utility.applyNoticeBtnCDP));
	...
	public void verifyConfirmationPopUpOpensAfterClickingApplyNoticeBtn() throws InterruptedException {
		...
		Assert.assertTrue(elementIsDisplayed(CDP_Utility.applyNoticeConfirmationPopup));
	...
	public void verifyConfirmationPopIsClosedAFterCancel() throws InterruptedException {
		...
		forcedWaitTime(1);
		Assert.assertFalse(elementIsDisplayed(CDP_Utility.applyNoticeConfirmationPopup));
	...
	public void verifyUserIsAbleToApplyNoticeAfterClickingYes() throws InterruptedException {
		...
		Assert.assertFalse(elementIsDisplayed(CDP_Utility.noticeCreatedIndependentOfInspectionHeader));
