...
public class SupervisorUtility extends Helper {
	...
	public static By completeInspAndGenerateNoticeForApproval2 = By.xpath("//button[text()='Issue Notice & Complete Inspection']");
...
//			Assert.assertFalse(true);
	...
	public void verifyUserIsAbleToEditCreatedGroupWithBasic() throws InterruptedException {
		forcedWaitTime(2);		
		int sizePage = fineElementsSize(noOfPagesInGroups);
		if(sizePage > 0) {
	...
	public void verifyEscalatedNoticeNeedsSupervisorApprovalMsgDisplayed() throws InterruptedException {
		...
		esacalateNoticeVadilationMsg = getTextByJSExecutor(PerformInspectionUtility.escalateNoticeValMsg);
	...
	public void verifyIssueNoticeAndCompleteInspectionNotDisplayed() {
		Boolean flag = elementIsDisplayed(PerformInspectionUtility.IssueNoticeButton);
...
//		waitForCurserRunning(5);
	...
	public void verifyUserIsAbleToRejectNotice() throws InterruptedException {
		...
		waitForCurserRunning(5);
		Thread.sleep(5000);
		Assert.assertFalse(elementIsDisplayed(NoticesUtility.saveBtnNoticePopUp));
