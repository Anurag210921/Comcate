...
public class CLPUtility extends Helper {
	...
	public void CLP_VerifyTotalCountOfCases() throws InterruptedException {
		...
		int caseCount = fineElementsSize(caseIds);
		...
		while(checkNext) {
			...
			WaitForGridTableEnable();
			forcedWaitTime(2);
			int case_Count = fineElementsSize(caseIds);
	...
	public void CLP_VerifyMineButtonApplication() throws InterruptedException {
		...
		List<WebElement> AssigneeList = driver.findElements(By.xpath("//span[@class='checkbox-holder']/following::span[2]"));
		int matched = 0;
	...
	public void VerifyEsclatedColAndPendingApprovalStatus() throws InterruptedException {
		...
		Boolean PendingApprovel = findElementByXPath(stringFormat(CLPColumn, "Pending Supervisor Approval"))
				.isDisplayed();
