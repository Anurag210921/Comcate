...
public class FlatFineWithNotice extends BrowsersInvoked {
	...
	@Test(priority = 1, description = "Verify validation message is displayed for label field on create fine page")
	public void flatFineWithNotice_verifyValidationMessageOnCreateFineForLabelField() throws InterruptedException {
	...
	@Test(priority = 2, description = "Verify user is able to create flat fine with no notice attached")
	public void flatFineWithNotice_verifyUserAbleToCreateFlatFineWithoutNotice() throws InterruptedException {
		fines.goToCreateFinePage();
		fines.createFlatFineWithoutNoticeAndFADoc();

	}

	@Test(priority = 3, description = "Verify user is able to edit flat fine created without notice")
	public void flatFineWithNotice_verifyUserAbleToEditFlatFineWithoutNotice() throws InterruptedException {
		fines.editFineWithoutNotice();

	}

	@Test(priority = 4, description = "Verify validation message is displayed on creating duplicate flat fine without notice")
	public void flatFineWithNotice_verifyValidationMessageDisplayedForDuplicateFine() throws InterruptedException {
		fines.verifyValidationMessageForDuplicateFine();

	}

	@Test(priority = 5, description = "Verify validation message is displayed for Amount field on create fine page")
	public void flatFineWithNotice_verifyValidationMessageOnCreateFineForAmountField() throws InterruptedException {
		fines.goToCreateFinePage();
	...
	public void flatFineWithNotice_verifyFlatFineAmountWithNoticeIsAddedUnderOutstandingBalance() throws InterruptedException {
	...
	public void flatFineWithNotice_verifyFlatFineWithNoticeDisplayedOnFinesAndPaymentsPage() throws InterruptedException {
	...
	public void flatFineWithNotice_verifyFlatFineWithNoticeAmountIsDisplayedForGenerateNotice() throws InterruptedException {
	...
	public void flatFineWithNotice_verifyOutstandingBalanceIsUpdatedAfterNoticeGeneratedIsApplied() throws InterruptedException {
	...
	public void flatFineWithNotice_verifyCorrectAmountOfFlatFineLinkedToFADocumentIsDisplayedOnFAA() throws InterruptedException {
	...
	public void flatFineWithNotice_verifyUserIsAbleToEditFlatFineLinkedToFADocumentIsDisplayedOnFAA() throws InterruptedException {
	...
	public void flatFineWithNotice_verifyFADocumentFineNameIsDisplayedOnFinesAndPaymentsPage() throws InterruptedException {
	...
	public void flatFineWithNotice_verifyFLatFineWithoutNoticeIsDisplayedOnFineAndPaymentsPage() throws InterruptedException {
	...
	public void flatFineWithNotice_verifyFLatFineWithoutNoticeIsAppliedOnFineAndPaymentsPage() throws InterruptedException {
	...
	public void flatFineWithNotice_verifyOutstandingBalanceUpdatedWhenFlatFineWithoutNoticeIsApplied() throws InterruptedException {
		fines.navigatToCDPFromFinesAndPaymentsPage();
