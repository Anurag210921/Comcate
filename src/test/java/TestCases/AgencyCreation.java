...
public class AgencyCreation extends BrowsersInvoked {
	...
	public void setUp() {
		...
		agencyCreation = new AgencyCreationUtility(driver);
   ...
   @Test(priority = 11,groups = {"GISDirect20","Enterprise","Hosted20"},description="Uploade parcel file and activate 2.0 for hosted only.")
	...
	public void AgencySetup_VerifySecuredLocationSettings() throws InterruptedException {
		...
		LocationManagmentUtility locMan = new LocationManagmentUtility(driver);
   ...
   public void AgencySetup_VerifyContactCustomFields() throws InterruptedException {
	...
	@Test(priority = 19,description = "Verify that user is able to Create Groups." ,groups = {"GISDirect20","Enterprise","Hosted20"})
	...
	@Test(priority = 20,groups = {"GISDirect20","Enterprise","Hosted20"})
	...
	/*
	 * @Test(priority = 25) public void AgencySetup_VerifyCreationOf50PlusCases()
	 ...
	 * AgencySetup_VerifyCreationOf50PlusSubmissions() throws InterruptedException {
	...
	@Test(priority = 33,groups = {"GISDirect20","Enterprise","Hosted20"})
	...
	@Test(priority = 34,groups = {"GISDirect20","Enterprise","Hosted20"})
	...
	@Test(priority = 36,description = "Verify that user is able to Create violation specific fines.",groups = {"GISDirect20","Enterprise","Hosted20"})
	...
	@Test(priority = 39,groups = {"GISDirect20","Enterprise","Hosted20"})
	...
	@Test(priority = 45,description = "Verify that user is able to delete Agency.",groups = {"GISDirect20","Enterprise","Hosted20"})
